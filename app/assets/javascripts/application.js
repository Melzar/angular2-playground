...
//= require @angular/forms/bundles/forms.umd
//= require @angular/http/bundles/http.umd
...
//= require @angular/router/bundles/router.umd
//= require @angular/upgrade/bundles/upgrade.umd
//= require_tree .
